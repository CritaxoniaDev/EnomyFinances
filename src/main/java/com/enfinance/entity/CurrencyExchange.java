...
public class CurrencyExchange {
	...
	public CurrencyExchange(Long id, User user, List<SavingsAndInvestments> investments, String fromCurrency,
	...
	public List<SavingsAndInvestments> getInvestments() {
	    return investments;
	}

	public void setInvestments(List<SavingsAndInvestments> investments) {
	    this.investments = investments;
	}
