...
public class SavingsAndInvestmentsServiceImpl implements SavingsAndInvestmentsService {
	...
	public Map<String, Object> calculateInvestment(String investmentType, BigDecimal initialInvestment,
		...
		// Set rates based on investment type
		...
		results.putAll(calculateProjection(initialInvestment, monthlyInvestment, minReturn, maxReturn, monthlyFee, 1));
		results.putAll(calculateProjection(initialInvestment, monthlyInvestment, minReturn, maxReturn, monthlyFee, 5));
		results.putAll(calculateProjection(initialInvestment, monthlyInvestment, minReturn, maxReturn, monthlyFee, 10));
